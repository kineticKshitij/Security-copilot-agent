...
class Config(BaseSettings):
    ...
    github_issue_labels: str = Field("security,nsg,misconfiguration", env="GITHUB_ISSUE_LABELS")
    ...
    def is_sql_configured(self) -> bool:
        ...
        return bool(
            self.azure_sql_connection_string or 
            (self.azure_sql_server and self.azure_sql_database)
        )
